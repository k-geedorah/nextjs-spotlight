...
const Page = () => {
    return (<>
        ...
        <div className="px-16 py-5 mb-16 grid grid-cols-2 gap-5">
            ...
            <div className='ml-10'>
                <img className='aspect-square w-96 mb-16 rounded-xl rotate-2' src='https://spotlight.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fportrait.79754e9e.jpg&w=1080&q=75'></img>
